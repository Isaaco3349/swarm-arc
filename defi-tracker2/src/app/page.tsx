          ...
          {activeTab==="explorer"&&(
            <div style={{border:"1px solid #1a2a1a",borderTop:"none"}}>
              ...
              {[
                ...
                { key: "tempoTestnet",     name: "Tempo",     explorerBase: "https://explore.tempo.xyz" },
                ...
                const fallbackUrl =
                  !address ? c.explorerBase :
                  c.key === "tempoTestnet" ? `${c.explorerBase.replace(/\/$/,"")}/${address}` :
                  `${c.explorerBase.replace(/\/$/,"")}/address/${address}`;
                const url = s?.explorerAddressUrl ?? fallbackUrl;
